...
<html lang="zh-cn">  
   <head>
	...
	<script src='<c:url value="/js/bootstrap-3.3.0/js/plugins/morris/raphael.min.js"/>'></script>
	<script src='<c:url value="/js/bootstrap-3.3.0/js/plugins/morris/morris.min.js"/>'></script>
	<script src='<c:url value="/js/bootstrap-3.3.0/js/plugins/morris/morris-data.js"/>'></script>
